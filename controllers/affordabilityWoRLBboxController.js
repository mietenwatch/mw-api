...
exports.index = (req, res, next) => {
  ...
  model.db.all(
    "SELECT geo_lon, geo_lat, obj_wohnflaeche as obj_flatSize, obj_zimmer AS obj_rooms, cst_gesamtmiete AS cst_totalCosts FROM mw_data WHERE cst_md_gesamtmiete != 'NA' AND geo_lat >= ? AND geo_lat <= ? AND geo_lon <= ? AND geo_lon >= ? AND " +
      roomsQuery,
